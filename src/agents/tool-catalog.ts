...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    ...
    label: "obsidian_backlinks",
    description: "Find Obsidian backlinks",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  {
    id: "obsidian_dead_ends",
    label: "obsidian_dead_ends",
    description: "List dead-end notes",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
